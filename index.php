...
<head>
	...
	<meta http-equiv="Refresh" content="<?php echo mt_rand(29, 120*8.69); ?>; url=http://fridge.labs.coops" />
...
foreach(array('html') as $cssele)
{
    ...
    <style>
    body { 
        background: url(/image/bg-<?php echo sprintf("%'.02d", mt_rand(1, 25)); ?>.jpg) no-repeat center center fixed !important; 
